...
// v5 i'm reducing the letter display time and reducing decoys down to just 24 letters. The goal being to create more opportunity for spelling team.
...
const char letterPool[] = {'T', 'E', 'A', 'M', 'N', 'F'};
const int letterDisplayDuration = 600; // ms
